...
namespace devhl.CoinMarketCap.Test.Api
{
    ...
    /// </summary>
    public sealed class BlockchainApiTests : ApiTestsBase
    {
        private readonly IBlockchainApi _instance;

        public BlockchainApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IBlockchainApi>();
        }


        /// <summary>
        /// Test GetV1BlockchainStatisticsLatest
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetV1BlockchainStatisticsLatestAsyncTest()
        {
            string? id = default;
            string? symbol = default;
            string? slug = default;
            var response = await _instance.GetV1BlockchainStatisticsLatestAsync(id, symbol, slug);
            Assert.IsType<BlockchainStatisticsLatestResponseModel>(response);
        }
    }
}
