...
namespace devhl.CoinMarketCap.Test.Api
{
    ...
    public sealed class ToolsApiTests : ApiTestsBase
    {
        ...
        /// <summary>
        /// Test GetV1ToolsPriceconversion
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetV1ToolsPriceconversionAsyncTest()
        {
            ...
            var response = await _instance.GetV1ToolsPriceconversionAsync(amount, id, symbol, time, convert, convertId);
            Assert.IsType<ToolsPriceConversionResponseModel>(response);
        }
    }
}
