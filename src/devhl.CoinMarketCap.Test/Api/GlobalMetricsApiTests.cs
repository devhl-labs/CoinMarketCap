...
{
    /// <summary>
    ///  Class for testing GlobalMetricsApi
    /// </summary>
    public sealed class GlobalMetricsApiTests : ApiTestsBase
    {
        private readonly IGlobalMetricsApi _instance;

        public GlobalMetricsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IGlobalMetricsApi>();
        }


        /// <summary>
        /// Test GetV1GlobalmetricsQuotesHistorical
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetV1GlobalmetricsQuotesHistoricalAsyncTest()
        {
            ...
            string? aux = default;
            var response = await _instance.GetV1GlobalmetricsQuotesHistoricalAsync(timeStart, timeEnd, count, interval, convert, convertId, aux);
            Assert.IsType<GlobalMetricsQuotesHistoricResponseModel>(response);
        }

        /// <summary>
        /// Test GetV1GlobalmetricsQuotesLatest
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetV1GlobalmetricsQuotesLatestAsyncTest()
        {
            string? convert = default;
            string? convertId = default;
            var response = await _instance.GetV1GlobalmetricsQuotesLatestAsync(convert, convertId);
            Assert.IsType<GlobalMetricsQuotesLatestResponseModel>(response);
        }
    }
}
