...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Account Info - Response Object")]
    public partial class AccountInfoResponseObject : IEquatable<AccountInfoResponseObject>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountInfoResponseObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountInfoResponseObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountInfoResponseObject" /> class.
        /// </summary>
        /// <param name="plan">plan (required).</param>
        /// <param name="usage">usage (required).</param>
        public AccountInfoResponseObject(Plan plan = default(Plan), Usage usage = default(Usage))
        {
            // to ensure "plan" is required (not null)
            if (plan == null) {
                throw new ArgumentNullException("plan is a required property for AccountInfoResponseObject and cannot be null");
            }
            this.Plan = plan;
            // to ensure "usage" is required (not null)
            if (usage == null) {
                throw new ArgumentNullException("usage is a required property for AccountInfoResponseObject and cannot be null");
            }
            this.Usage = usage;
        }
        ...
        {
            return this.Equals(input as AccountInfoResponseObject);
        }

        /// <summary>
        /// Returns true if AccountInfoResponseObject instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountInfoResponseObject to be compared</param>
        /// <returns>Boolean</returns>
