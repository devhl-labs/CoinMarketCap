...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Cryptocurrency Listings Latest - Quote object 1")]
    public partial class CryptocurrencyListingsLatestQuoteObject1 : IEquatable<CryptocurrencyListingsLatestQuoteObject1>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyListingsLatestQuoteObject1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CryptocurrencyListingsLatestQuoteObject1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyListingsLatestQuoteObject1" /> class.
        /// </summary>
        /// <param name="price">Price in the specified currency for this historical. (required).</param>
        ...
        public CryptocurrencyListingsLatestQuoteObject1(decimal price = default(decimal), decimal volume24h = default(decimal), decimal volumeChange24h = default(decimal), decimal volume24hReported = default(decimal), decimal volume7d = default(decimal), decimal volume7dReported = default(decimal), decimal volume30d = default(decimal), decimal volume30dReported = default(decimal), decimal marketCap = default(decimal), decimal marketCapDominance = default(decimal), decimal fullyDilutedMarketCap = default(decimal), decimal percentChange1h = default(decimal), decimal percentChange24h = default(decimal), decimal percentChange7d = default(decimal), DateTime lastUpdated = default(DateTime))
        {
            this.Price = price;
        ...
        /// </summary>
        /// <value>Price in the specified currency for this historical.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CryptocurrencyListingsLatestQuoteObject1 {\n");
        ...
        {
            return this.Equals(input as CryptocurrencyListingsLatestQuoteObject1);
        }

        /// <summary>
        /// Returns true if CryptocurrencyListingsLatestQuoteObject1 instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptocurrencyListingsLatestQuoteObject1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptocurrencyListingsLatestQuoteObject1 input)
        {
            if (input == null)
            {
                return false;
