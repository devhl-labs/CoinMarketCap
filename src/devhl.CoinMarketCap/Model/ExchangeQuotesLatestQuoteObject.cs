...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Exchange Quotes Latest - Quote object")]
    public partial class ExchangeQuotesLatestQuoteObject : IEquatable<ExchangeQuotesLatestQuoteObject>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeQuotesLatestQuoteObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExchangeQuotesLatestQuoteObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeQuotesLatestQuoteObject" /> class.
        /// </summary>
        ...
        /// <param name="percentChangeVolume24h">24 hour percent change in the specified currency. (required).</param>
        /// <param name="percentChangeVolume7d">7 day percent change in the specified currency. (required).</param>
        /// <param name="percentChangeVolume30d">30 day percent change in the specified currency. (required).</param>
        ...
        /// <param name="spotVolume">Reported 24 hour spot volume in the specified currency..</param>
        public ExchangeQuotesLatestQuoteObject(DateTime lastUpdated = default(DateTime), decimal volume24h = default(decimal), decimal volume24hAdjusted = default(decimal), decimal volume7d = default(decimal), decimal volume30d = default(decimal), decimal percentChangeVolume24h = default(decimal), decimal percentChangeVolume7d = default(decimal), decimal percentChangeVolume30d = default(decimal), decimal effectiveLiquidity24h = default(decimal), decimal derivativeVolume = default(decimal), decimal spotVolume = default(decimal))
        {
        ...
        /// </summary>
        /// <value>24 hour percent change in the specified currency.</value>
        ...
        /// </summary>
        /// <value>7 day percent change in the specified currency.</value>
        ...
        /// </summary>
        /// <value>30 day percent change in the specified currency.</value>
        ...
        /// </summary>
        /// <value>Reported 24 hour spot volume in the specified currency.</value>
        [DataMember(Name = "spot_volume", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SpotVolume: ").Append(SpotVolume).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ExchangeQuotesLatestQuoteObject);
        }

        /// <summary>
        /// Returns true if ExchangeQuotesLatestQuoteObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ExchangeQuotesLatestQuoteObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExchangeQuotesLatestQuoteObject input)
        {
            ...
            return 
                ...
                (
                    this.SpotVolume == input.SpotVolume ||
                    this.SpotVolume.Equals(input.SpotVolume)
                );
        }
