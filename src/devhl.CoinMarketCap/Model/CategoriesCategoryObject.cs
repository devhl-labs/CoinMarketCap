...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Categories - Category object")]
    public partial class CategoriesCategoryObject : IEquatable<CategoriesCategoryObject>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CategoriesCategoryObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CategoriesCategoryObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CategoriesCategoryObject" /> class.
        /// </summary>
        ...
        public CategoriesCategoryObject(int id = default(int), string name = default(string), string title = default(string), string description = default(string), int numTokens = default(int), decimal avgPriceChange = default(decimal), decimal marketCap = default(decimal), decimal marketCapChange = default(decimal), decimal volume = default(decimal), decimal volumeChange = default(decimal), DateTime lastUpdated = default(DateTime))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CategoriesCategoryObject {\n");
        ...
        {
            return this.Equals(input as CategoriesCategoryObject);
        }

        /// <summary>
        /// Returns true if CategoriesCategoryObject instances are equal
        /// </summary>
        /// <param name="input">Instance of CategoriesCategoryObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CategoriesCategoryObject input)
        {
            if (input == null)
                return false;
