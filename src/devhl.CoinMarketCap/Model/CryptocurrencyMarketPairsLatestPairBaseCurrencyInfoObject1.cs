...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Cryptocurrency Market Pairs Latest - Pair Base Currency Info object 1")]
    public partial class CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject1 : IEquatable<CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject1>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject1" /> class.
        /// </summary>
        ...
        public CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject1(int currencyId = default(int), string currencyName = default(string), string currencySymbol = default(string), string currencySlug = default(string), string exchangeSymbol = default(string), CurrencyTypeEnum currencyType = default(CurrencyTypeEnum))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject1 {\n");
        ...
        {
            return this.Equals(input as CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject1);
        }

        /// <summary>
        /// Returns true if CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject1 instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject1 input)
        {
            if (input == null)
            {
                return false;
