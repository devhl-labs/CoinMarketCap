...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Airdrop - Results map")]
    public partial class AirdropResultsMap : IEquatable<AirdropResultsMap>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AirdropResultsMap" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AirdropResultsMap() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AirdropResultsMap" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        public AirdropResultsMap(AirdropAirdropObject key = default(AirdropAirdropObject))
        {
            // to ensure "key" is required (not null)
            if (key == null) {
                throw new ArgumentNullException("key is a required property for AirdropResultsMap and cannot be null");
            }
            this.Key = key;
        }
        ...
        public AirdropAirdropObject Key { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AirdropResultsMap {\n");
        ...
        {
            return this.Equals(input as AirdropResultsMap);
        }

        /// <summary>
        /// Returns true if AirdropResultsMap instances are equal
        /// </summary>
        /// <param name="input">Instance of AirdropResultsMap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AirdropResultsMap input)
        {
            if (input == null)
                return false;
