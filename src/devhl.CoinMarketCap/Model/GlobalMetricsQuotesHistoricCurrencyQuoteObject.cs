...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Global Metrics Quotes Historic - Currency Quote object")]
    public partial class GlobalMetricsQuotesHistoricCurrencyQuoteObject : IEquatable<GlobalMetricsQuotesHistoricCurrencyQuoteObject>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobalMetricsQuotesHistoricCurrencyQuoteObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GlobalMetricsQuotesHistoricCurrencyQuoteObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobalMetricsQuotesHistoricCurrencyQuoteObject" /> class.
        /// </summary>
        /// <param name="totalMarketCap">The sum of all individual cryptocurrency market capitalizations at the given point in time, historically converted into units of the requested currency. (required).</param>
        /// <param name="totalVolume24h">The sum of rolling 24 hour adjusted volume (as outlined in our methodology) for all cryptocurrencies at the given point in time, historically converted into units of the requested currency. (required).</param>
        /// <param name="totalVolume24hReported">The sum of rolling 24 hour reported volume for all cryptocurrencies at the given point in time, historically converted into units of the requested currency. *Note: This field is only available after 2019-05-10 and will return &#x60;null&#x60; prior to that time.* (required).</param>
        /// <param name="altcoinMarketCap">The sum of rolling 24 hour adjusted volume (as outlined in our methodology) for all cryptocurrencies excluding Bitcoin at the given point in time, historically converted into units of the requested currency. (required).</param>
        /// <param name="altcoinVolume24h">The sum of all individual cryptocurrency market capitalizations excluding Bitcoin at the given point in time, historically converted into units of the requested currency. (required).</param>
        /// <param name="altcoinVolume24hReported">The sum of rolling 24 hour reported volume for all cryptocurrencies excluding Bitcoin at the given point in time, historically converted into units of the requested currency. *Note: This field is only available after 2019-05-10 and will return &#x60;null&#x60; prior to that time.* (required).</param>
        ...
        public GlobalMetricsQuotesHistoricCurrencyQuoteObject(decimal totalMarketCap = default(decimal), decimal totalVolume24h = default(decimal), decimal totalVolume24hReported = default(decimal), decimal altcoinMarketCap = default(decimal), decimal altcoinVolume24h = default(decimal), decimal altcoinVolume24hReported = default(decimal), DateTime timestamp = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>The sum of all individual cryptocurrency market capitalizations at the given point in time, historically converted into units of the requested currency.</value>
        ...
        /// </summary>
        /// <value>The sum of rolling 24 hour adjusted volume (as outlined in our methodology) for all cryptocurrencies at the given point in time, historically converted into units of the requested currency.</value>
        ...
        /// </summary>
        /// <value>The sum of rolling 24 hour reported volume for all cryptocurrencies at the given point in time, historically converted into units of the requested currency. *Note: This field is only available after 2019-05-10 and will return &#x60;null&#x60; prior to that time.*</value>
        ...
        /// </summary>
        /// <value>The sum of rolling 24 hour adjusted volume (as outlined in our methodology) for all cryptocurrencies excluding Bitcoin at the given point in time, historically converted into units of the requested currency.</value>
        ...
        /// </summary>
        /// <value>The sum of all individual cryptocurrency market capitalizations excluding Bitcoin at the given point in time, historically converted into units of the requested currency.</value>
        ...
        /// </summary>
        /// <value>The sum of rolling 24 hour reported volume for all cryptocurrencies excluding Bitcoin at the given point in time, historically converted into units of the requested currency. *Note: This field is only available after 2019-05-10 and will return &#x60;null&#x60; prior to that time.*</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlobalMetricsQuotesHistoricCurrencyQuoteObject {\n");
        ...
        {
            return this.Equals(input as GlobalMetricsQuotesHistoricCurrencyQuoteObject);
        }

        /// <summary>
        /// Returns true if GlobalMetricsQuotesHistoricCurrencyQuoteObject instances are equal
        /// </summary>
        /// <param name="input">Instance of GlobalMetricsQuotesHistoricCurrencyQuoteObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlobalMetricsQuotesHistoricCurrencyQuoteObject input)
        {
            if (input == null)
                return false;
