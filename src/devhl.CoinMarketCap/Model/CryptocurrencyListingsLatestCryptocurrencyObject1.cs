...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Cryptocurrency Listings Latest - Cryptocurrency object 1")]
    public partial class CryptocurrencyListingsLatestCryptocurrencyObject1 : IEquatable<CryptocurrencyListingsLatestCryptocurrencyObject1>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyListingsLatestCryptocurrencyObject1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CryptocurrencyListingsLatestCryptocurrencyObject1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyListingsLatestCryptocurrencyObject1" /> class.
        /// </summary>
        ...
        public CryptocurrencyListingsLatestCryptocurrencyObject1(int id = default(int), string name = default(string), string symbol = default(string), string slug = default(string), int cmcRank = default(int), int numMarketPairs = default(int), decimal circulatingSupply = default(decimal), decimal totalSupply = default(decimal), decimal marketCapByTotalSupply = default(decimal), decimal maxSupply = default(decimal), DateTime lastUpdated = default(DateTime), DateTime dateAdded = default(DateTime), List<string> tags = default(List<string>), Platform platform = default(Platform), CryptocurrencyListingsLatestQuoteMap1 quote = default(CryptocurrencyListingsLatestQuoteMap1))
        {
            this.Id = id;
            this.Name = name;
            this.Symbol = symbol;
            ...
            if (quote == null) {
                throw new ArgumentNullException("quote is a required property for CryptocurrencyListingsLatestCryptocurrencyObject1 and cannot be null");
            }
            this.Quote = quote;
        ...
        public CryptocurrencyListingsLatestQuoteMap1 Quote { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CryptocurrencyListingsLatestCryptocurrencyObject1 {\n");
        ...
        {
            return this.Equals(input as CryptocurrencyListingsLatestCryptocurrencyObject1);
        }

        /// <summary>
        /// Returns true if CryptocurrencyListingsLatestCryptocurrencyObject1 instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptocurrencyListingsLatestCryptocurrencyObject1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptocurrencyListingsLatestCryptocurrencyObject1 input)
        {
            if (input == null)
            {
                return false;
