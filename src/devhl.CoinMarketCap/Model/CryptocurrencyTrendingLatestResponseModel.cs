...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Cryptocurrency Trending Latest - Response Model")]
    public partial class CryptocurrencyTrendingLatestResponseModel : IEquatable<CryptocurrencyTrendingLatestResponseModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyTrendingLatestResponseModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CryptocurrencyTrendingLatestResponseModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyTrendingLatestResponseModel" /> class.
        /// </summary>
        /// <param name="data">Array of cryptocurrency objects matching the list options. (required).</param>
        /// <param name="status">status.</param>
        public CryptocurrencyTrendingLatestResponseModel(List<CryptocurrencyCryptocurrencyObject> data = default(List<CryptocurrencyCryptocurrencyObject>), APIStatusObject status = default(APIStatusObject))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for CryptocurrencyTrendingLatestResponseModel and cannot be null");
            }
            this.Data = data;
            this.Status = status;
        }
        ...
        {
            return this.Equals(input as CryptocurrencyTrendingLatestResponseModel);
        }

        /// <summary>
        /// Returns true if CryptocurrencyTrendingLatestResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptocurrencyTrendingLatestResponseModel to be compared</param>
        /// <returns>Boolean</returns>
