...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Tools Price Conversion - Quotes map")]
    public partial class ToolsPriceConversionQuotesMap : IEquatable<ToolsPriceConversionQuotesMap>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolsPriceConversionQuotesMap" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ToolsPriceConversionQuotesMap() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolsPriceConversionQuotesMap" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        public ToolsPriceConversionQuotesMap(ToolsPriceConversionQuoteObject key = default(ToolsPriceConversionQuoteObject))
        {
            // to ensure "key" is required (not null)
            if (key == null) {
                throw new ArgumentNullException("key is a required property for ToolsPriceConversionQuotesMap and cannot be null");
            }
            this.Key = key;
        }
        ...
        public ToolsPriceConversionQuoteObject Key { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ToolsPriceConversionQuotesMap {\n");
        ...
        {
            return this.Equals(input as ToolsPriceConversionQuotesMap);
        }

        /// <summary>
        /// Returns true if ToolsPriceConversionQuotesMap instances are equal
        /// </summary>
        /// <param name="input">Instance of ToolsPriceConversionQuotesMap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ToolsPriceConversionQuotesMap input)
        {
            if (input == null)
            {
                return false;
