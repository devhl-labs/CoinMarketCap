...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Cryptocurrency Quotes Latest - Cryptocurrency object")]
    public partial class CryptocurrencyQuotesLatestCryptocurrencyObject : IEquatable<CryptocurrencyQuotesLatestCryptocurrencyObject>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyQuotesLatestCryptocurrencyObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CryptocurrencyQuotesLatestCryptocurrencyObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyQuotesLatestCryptocurrencyObject" /> class.
        /// </summary>
        ...
        /// <param name="quote">A map of market quotes in different currency conversions. The default map included is USD. (required).</param>
        public CryptocurrencyQuotesLatestCryptocurrencyObject(int id = default(int), string name = default(string), string symbol = default(string), string slug = default(string), int isActive = default(int), int isFiat = default(int), int cmcRank = default(int), int numMarketPairs = default(int), decimal circulatingSupply = default(decimal), decimal totalSupply = default(decimal), decimal marketCapByTotalSupply = default(decimal), decimal maxSupply = default(decimal), DateTime dateAdded = default(DateTime), List<string> tags = default(List<string>), Platform platform = default(Platform), DateTime lastUpdated = default(DateTime), Dictionary<string, CryptocurrencyQuotesLatestQuoteObject> quote = default(Dictionary<string, CryptocurrencyQuotesLatestQuoteObject>))
        {
            this.Id = id;
            this.Name = name;
            this.Symbol = symbol;
            ...
            if (quote == null) {
                throw new ArgumentNullException("quote is a required property for CryptocurrencyQuotesLatestCryptocurrencyObject and cannot be null");
            }
            this.Quote = quote;
        ...
        /// </summary>
        /// <value>A map of market quotes in different currency conversions. The default map included is USD.</value>
        [DataMember(Name = "quote", IsRequired = true, EmitDefaultValue = false)]
        public Dictionary<string, CryptocurrencyQuotesLatestQuoteObject> Quote { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CryptocurrencyQuotesLatestCryptocurrencyObject {\n");
        ...
        {
            return this.Equals(input as CryptocurrencyQuotesLatestCryptocurrencyObject);
        }

        /// <summary>
        /// Returns true if CryptocurrencyQuotesLatestCryptocurrencyObject instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptocurrencyQuotesLatestCryptocurrencyObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptocurrencyQuotesLatestCryptocurrencyObject input)
        {
            if (input == null)
                return false;
