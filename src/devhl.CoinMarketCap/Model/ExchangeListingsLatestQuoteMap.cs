...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Exchange Listings Latest - Quote map")]
    public partial class ExchangeListingsLatestQuoteMap : IEquatable<ExchangeListingsLatestQuoteMap>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeListingsLatestQuoteMap" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExchangeListingsLatestQuoteMap() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeListingsLatestQuoteMap" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        public ExchangeListingsLatestQuoteMap(ExchangeListingsLatestQuoteObject key = default(ExchangeListingsLatestQuoteObject))
        {
            // to ensure "key" is required (not null)
            if (key == null) {
                throw new ArgumentNullException("key is a required property for ExchangeListingsLatestQuoteMap and cannot be null");
            }
            this.Key = key;
        }
        ...
        public ExchangeListingsLatestQuoteObject Key { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExchangeListingsLatestQuoteMap {\n");
        ...
        {
            return this.Equals(input as ExchangeListingsLatestQuoteMap);
        }

        /// <summary>
        /// Returns true if ExchangeListingsLatestQuoteMap instances are equal
        /// </summary>
        /// <param name="input">Instance of ExchangeListingsLatestQuoteMap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExchangeListingsLatestQuoteMap input)
        {
            if (input == null)
            {
                return false;
