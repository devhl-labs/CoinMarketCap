...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// Status2
    /// </summary>
    [DataContract(Name = "status 2")]
    public partial class Status2 : IEquatable<Status2>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Status2" /> class.
        /// </summary>
        ...
        public Status2(DateTime timestamp = default(DateTime), int errorCode = default(int), string errorMessage = default(string), int elapsed = default(int), int creditCount = default(int))
        {
        ...
        {
            return this.Equals(input as Status2);
        }

        /// <summary>
        /// Returns true if Status2 instances are equal
        /// </summary>
        /// <param name="input">Instance of Status2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Status2 input)
        {
            if (input == null)
                return false;
