...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Exchanges Info - Response Model")]
    public partial class ExchangesInfoResponseModel : IEquatable<ExchangesInfoResponseModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangesInfoResponseModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExchangesInfoResponseModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangesInfoResponseModel" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="status">status.</param>
        public ExchangesInfoResponseModel(ExchangesInfoResultsMap data = default(ExchangesInfoResultsMap), APIStatusObject status = default(APIStatusObject))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for ExchangesInfoResponseModel and cannot be null");
            }
            this.Data = data;
            this.Status = status;
        }
        ...
        public ExchangesInfoResultsMap Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExchangesInfoResponseModel {\n");
        ...
        {
            return this.Equals(input as ExchangesInfoResponseModel);
        }

        /// <summary>
        /// Returns true if ExchangesInfoResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ExchangesInfoResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExchangesInfoResponseModel input)
        {
            if (input == null)
                return false;
