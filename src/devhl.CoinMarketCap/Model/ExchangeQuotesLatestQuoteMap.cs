...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Exchange Quotes Latest - Quote map")]
    public partial class ExchangeQuotesLatestQuoteMap : IEquatable<ExchangeQuotesLatestQuoteMap>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeQuotesLatestQuoteMap" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExchangeQuotesLatestQuoteMap() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeQuotesLatestQuoteMap" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        public ExchangeQuotesLatestQuoteMap(ExchangeQuotesLatestQuoteObject key = default(ExchangeQuotesLatestQuoteObject))
        {
            // to ensure "key" is required (not null)
            if (key == null) {
                throw new ArgumentNullException("key is a required property for ExchangeQuotesLatestQuoteMap and cannot be null");
            }
            this.Key = key;
        }
        ...
        public ExchangeQuotesLatestQuoteObject Key { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExchangeQuotesLatestQuoteMap {\n");
        ...
        {
            return this.Equals(input as ExchangeQuotesLatestQuoteMap);
        }

        /// <summary>
        /// Returns true if ExchangeQuotesLatestQuoteMap instances are equal
        /// </summary>
        /// <param name="input">Instance of ExchangeQuotesLatestQuoteMap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExchangeQuotesLatestQuoteMap input)
        {
            if (input == null)
            {
                return false;
