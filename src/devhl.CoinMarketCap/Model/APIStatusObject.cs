...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API Status Object")]
    public partial class APIStatusObject : IEquatable<APIStatusObject>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APIStatusObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected APIStatusObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="APIStatusObject" /> class.
        /// </summary>
        /// <param name="timestamp">Current timestamp (ISO 8601) on the server. (required).</param>
        /// <param name="errorCode">An internal error code for the current error. If a unique platform error code is not available the HTTP status code is returned. &#x60;null&#x60; is returned if there is no error. (required).</param>
        ...
        /// <param name="creditCount">Number of API call credits that were used for this call. (required).</param>
        public APIStatusObject(DateTime timestamp = default(DateTime), int errorCode = default(int), string errorMessage = default(string), int elapsed = default(int), int creditCount = default(int))
        {
        ...
        /// </summary>
        /// <value>Current timestamp (ISO 8601) on the server.</value>
        ...
        /// </summary>
        /// <value>An internal error code for the current error. If a unique platform error code is not available the HTTP status code is returned. &#x60;null&#x60; is returned if there is no error.</value>
        ...
        /// </summary>
        /// <value>Number of API call credits that were used for this call.</value>
        ...
        {
            return this.Equals(input as APIStatusObject);
        }

        /// <summary>
        /// Returns true if APIStatusObject instances are equal
        /// </summary>
        /// <param name="input">Instance of APIStatusObject to be compared</param>
        /// <returns>Boolean</returns>
