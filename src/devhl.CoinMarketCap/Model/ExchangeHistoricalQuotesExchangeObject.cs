...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Exchange Historical Quotes - exchange object")]
    public partial class ExchangeHistoricalQuotesExchangeObject : IEquatable<ExchangeHistoricalQuotesExchangeObject>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeHistoricalQuotesExchangeObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExchangeHistoricalQuotesExchangeObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeHistoricalQuotesExchangeObject" /> class.
        /// </summary>
        ...
        /// <param name="quotes">An array of quotes for each interval for this exchange. (required).</param>
        public ExchangeHistoricalQuotesExchangeObject(int id = default(int), string name = default(string), string slug = default(string), List<ExchangeHistoricalQuotesNtervalQuoteObject> quotes = default(List<ExchangeHistoricalQuotesNtervalQuoteObject>))
        {
            this.Id = id;
            this.Name = name;
            this.Slug = slug;
            ...
            if (quotes == null) {
                throw new ArgumentNullException("quotes is a required property for ExchangeHistoricalQuotesExchangeObject and cannot be null");
            }
            this.Quotes = quotes;
        }
        ...
        /// </summary>
        /// <value>An array of quotes for each interval for this exchange.</value>
        [DataMember(Name = "quotes", IsRequired = true, EmitDefaultValue = false)]
        public List<ExchangeHistoricalQuotesNtervalQuoteObject> Quotes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExchangeHistoricalQuotesExchangeObject {\n");
        ...
        {
            return this.Equals(input as ExchangeHistoricalQuotesExchangeObject);
        }

        /// <summary>
        /// Returns true if ExchangeHistoricalQuotesExchangeObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ExchangeHistoricalQuotesExchangeObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExchangeHistoricalQuotesExchangeObject input)
        {
            if (input == null)
            {
                return false;
