...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Cryptocurrency Market Pairs Latest - Market Pair Exchange Reported Quote")]
    public partial class CryptocurrencyMarketPairsLatestMarketPairExchangeReportedQuote : IEquatable<CryptocurrencyMarketPairsLatestMarketPairExchangeReportedQuote>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyMarketPairsLatestMarketPairExchangeReportedQuote" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CryptocurrencyMarketPairsLatestMarketPairExchangeReportedQuote() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyMarketPairsLatestMarketPairExchangeReportedQuote" /> class.
        /// </summary>
        /// <param name="price">The lastest exchange reported price for this market pair in quote currency units. (required).</param>
        /// <param name="volume24hBase">The latest exchange reported 24 hour rolling volume for this market pair in base cryptocurrency units. (required).</param>
        /// <param name="volume24hQuote">The latest exchange reported 24 hour rolling volume for this market pair in quote cryptocurrency units. (required).</param>
        /// <param name="lastUpdated">Timestamp (ISO 8601) of the last time this market data was updated. (required).</param>
        public CryptocurrencyMarketPairsLatestMarketPairExchangeReportedQuote(decimal price = default(decimal), decimal volume24hBase = default(decimal), decimal volume24hQuote = default(decimal), DateTime lastUpdated = default(DateTime))
        {
            this.Price = price;
        ...
        /// </summary>
        /// <value>The lastest exchange reported price for this market pair in quote currency units.</value>
        ...
        /// </summary>
        /// <value>The latest exchange reported 24 hour rolling volume for this market pair in base cryptocurrency units.</value>
        ...
        /// </summary>
        /// <value>The latest exchange reported 24 hour rolling volume for this market pair in quote cryptocurrency units.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CryptocurrencyMarketPairsLatestMarketPairExchangeReportedQuote {\n");
        ...
        {
            return this.Equals(input as CryptocurrencyMarketPairsLatestMarketPairExchangeReportedQuote);
        }

        /// <summary>
        /// Returns true if CryptocurrencyMarketPairsLatestMarketPairExchangeReportedQuote instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptocurrencyMarketPairsLatestMarketPairExchangeReportedQuote to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptocurrencyMarketPairsLatestMarketPairExchangeReportedQuote input)
        {
            if (input == null)
            {
                return false;
