...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Cryptocurrency - Quote map")]
    public partial class CryptocurrencyQuoteMap : IEquatable<CryptocurrencyQuoteMap>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyQuoteMap" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CryptocurrencyQuoteMap() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyQuoteMap" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        public CryptocurrencyQuoteMap(CryptocurrencyQuoteObject key = default(CryptocurrencyQuoteObject))
        {
            // to ensure "key" is required (not null)
            if (key == null) {
                throw new ArgumentNullException("key is a required property for CryptocurrencyQuoteMap and cannot be null");
            }
            this.Key = key;
        }
        ...
        public CryptocurrencyQuoteObject Key { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CryptocurrencyQuoteMap {\n");
        ...
        {
            return this.Equals(input as CryptocurrencyQuoteMap);
        }

        /// <summary>
        /// Returns true if CryptocurrencyQuoteMap instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptocurrencyQuoteMap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptocurrencyQuoteMap input)
        {
            if (input == null)
                return false;
