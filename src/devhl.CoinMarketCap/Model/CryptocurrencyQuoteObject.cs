...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Cryptocurrency - Quote object")]
    public partial class CryptocurrencyQuoteObject : IEquatable<CryptocurrencyQuoteObject>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyQuoteObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CryptocurrencyQuoteObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyQuoteObject" /> class.
        /// </summary>
        ...
        public CryptocurrencyQuoteObject(decimal price = default(decimal), decimal volume24h = default(decimal), decimal volume24hReported = default(decimal), decimal volume7d = default(decimal), decimal volume7dReported = default(decimal), decimal volume30d = default(decimal), decimal volume30dReported = default(decimal), decimal marketCap = default(decimal), decimal percentChange1h = default(decimal), decimal percentChange24h = default(decimal), decimal percentChange7d = default(decimal), DateTime lastUpdated = default(DateTime))
        {
            this.Price = price;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CryptocurrencyQuoteObject {\n");
        ...
        {
            return this.Equals(input as CryptocurrencyQuoteObject);
        }

        /// <summary>
        /// Returns true if CryptocurrencyQuoteObject instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptocurrencyQuoteObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptocurrencyQuoteObject input)
        {
            if (input == null)
                return false;
