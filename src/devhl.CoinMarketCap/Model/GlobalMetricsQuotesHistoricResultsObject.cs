...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Global Metrics Quotes Historic - Results object")]
    public partial class GlobalMetricsQuotesHistoricResultsObject : IEquatable<GlobalMetricsQuotesHistoricResultsObject>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobalMetricsQuotesHistoricResultsObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GlobalMetricsQuotesHistoricResultsObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobalMetricsQuotesHistoricResultsObject" /> class.
        /// </summary>
        /// <param name="quotes">An array of aggregate market quotes for each interval. (required).</param>
        public GlobalMetricsQuotesHistoricResultsObject(List<GlobalMetricsQuotesHistoricIntervalQuoteObject> quotes = default(List<GlobalMetricsQuotesHistoricIntervalQuoteObject>))
        {
            // to ensure "quotes" is required (not null)
            if (quotes == null) {
                throw new ArgumentNullException("quotes is a required property for GlobalMetricsQuotesHistoricResultsObject and cannot be null");
            }
            this.Quotes = quotes;
        }
        ...
        /// </summary>
        /// <value>An array of aggregate market quotes for each interval.</value>
        [DataMember(Name = "quotes", IsRequired = true, EmitDefaultValue = false)]
        public List<GlobalMetricsQuotesHistoricIntervalQuoteObject> Quotes { get; set; }
        ...
        {
            return this.Equals(input as GlobalMetricsQuotesHistoricResultsObject);
        }

        /// <summary>
        /// Returns true if GlobalMetricsQuotesHistoricResultsObject instances are equal
        /// </summary>
        /// <param name="input">Instance of GlobalMetricsQuotesHistoricResultsObject to be compared</param>
        /// <returns>Boolean</returns>
