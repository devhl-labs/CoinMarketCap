...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// Forbidden
    /// </summary>
    [DataContract(Name = "HTTP Status 403 Error Object")]
    public partial class HTTPStatus403ErrorObject : IEquatable<HTTPStatus403ErrorObject>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HTTPStatus403ErrorObject" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public HTTPStatus403ErrorObject(Status2 status = default(Status2))
        {
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HTTPStatus403ErrorObject {\n");
        ...
        {
            return this.Equals(input as HTTPStatus403ErrorObject);
        }

        /// <summary>
        /// Returns true if HTTPStatus403ErrorObject instances are equal
        /// </summary>
        /// <param name="input">Instance of HTTPStatus403ErrorObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HTTPStatus403ErrorObject input)
        {
            if (input == null)
            {
                return false;
