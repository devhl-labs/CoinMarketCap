...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Cryptocurrency Listings Latest - Response Model")]
    public partial class CryptocurrencyListingsLatestResponseModel : IEquatable<CryptocurrencyListingsLatestResponseModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyListingsLatestResponseModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CryptocurrencyListingsLatestResponseModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyListingsLatestResponseModel" /> class.
        /// </summary>
        /// <param name="data">Array of cryptocurrency objects matching the list options. (required).</param>
        /// <param name="status">status.</param>
        public CryptocurrencyListingsLatestResponseModel(List<CryptocurrencyListingsLatestCryptocurrencyObject> data = default(List<CryptocurrencyListingsLatestCryptocurrencyObject>), APIStatusObject status = default(APIStatusObject))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for CryptocurrencyListingsLatestResponseModel and cannot be null");
            }
            this.Data = data;
            this.Status = status;
        }
        ...
        public List<CryptocurrencyListingsLatestCryptocurrencyObject> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CryptocurrencyListingsLatestResponseModel {\n");
        ...
        {
            return this.Equals(input as CryptocurrencyListingsLatestResponseModel);
        }

        /// <summary>
        /// Returns true if CryptocurrencyListingsLatestResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptocurrencyListingsLatestResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptocurrencyListingsLatestResponseModel input)
        {
            if (input == null)
            {
                return false;
