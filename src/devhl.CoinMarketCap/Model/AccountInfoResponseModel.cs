...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Account Info - Response Model")]
    public partial class AccountInfoResponseModel : IEquatable<AccountInfoResponseModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountInfoResponseModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountInfoResponseModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountInfoResponseModel" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="status">status.</param>
        public AccountInfoResponseModel(AccountInfoResponseObject data = default(AccountInfoResponseObject), APIStatusObject status = default(APIStatusObject))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for AccountInfoResponseModel and cannot be null");
            }
            this.Data = data;
            this.Status = status;
        }
        ...
        public AccountInfoResponseObject Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountInfoResponseModel {\n");
        ...
        {
            return this.Equals(input as AccountInfoResponseModel);
        }

        /// <summary>
        /// Returns true if AccountInfoResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountInfoResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountInfoResponseModel input)
        {
            if (input == null)
            {
                return false;
