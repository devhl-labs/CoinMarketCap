...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Cryptocurrency OHLCV Latest - Quote map")]
    public partial class CryptocurrencyOHLCVLatestQuoteMap : IEquatable<CryptocurrencyOHLCVLatestQuoteMap>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyOHLCVLatestQuoteMap" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CryptocurrencyOHLCVLatestQuoteMap() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyOHLCVLatestQuoteMap" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        public CryptocurrencyOHLCVLatestQuoteMap(CryptocurrencyOHLCVLatestQuoteObject key = default(CryptocurrencyOHLCVLatestQuoteObject))
        {
            // to ensure "key" is required (not null)
            if (key == null) {
                throw new ArgumentNullException("key is a required property for CryptocurrencyOHLCVLatestQuoteMap and cannot be null");
            }
            this.Key = key;
        }
        ...
        public CryptocurrencyOHLCVLatestQuoteObject Key { get; set; }
        ...
        {
            return this.Equals(input as CryptocurrencyOHLCVLatestQuoteMap);
        }

        /// <summary>
        /// Returns true if CryptocurrencyOHLCVLatestQuoteMap instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptocurrencyOHLCVLatestQuoteMap to be compared</param>
        /// <returns>Boolean</returns>
