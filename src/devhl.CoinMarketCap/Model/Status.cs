...
namespace devhl.CoinMarketCap.Model
{
    ...
    public partial class Status : IEquatable<Status>
    {
        ...
        public Status(DateTime timestamp = default(DateTime), int errorCode = default(int), string errorMessage = default(string), int elapsed = default(int), int creditCount = default(int))
        {
