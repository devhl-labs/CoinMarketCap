...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Fiat Map - Response Model")]
    public partial class FiatMapResponseModel : IEquatable<FiatMapResponseModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FiatMapResponseModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FiatMapResponseModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FiatMapResponseModel" /> class.
        /// </summary>
        /// <param name="data">Array of fiat object results. (required).</param>
        /// <param name="status">status.</param>
        public FiatMapResponseModel(List<FiatMapFiatObject> data = default(List<FiatMapFiatObject>), APIStatusObject status = default(APIStatusObject))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for FiatMapResponseModel and cannot be null");
            }
            this.Data = data;
            this.Status = status;
        }
        ...
        /// </summary>
        /// <value>Array of fiat object results.</value>
        [DataMember(Name = "data", IsRequired = true, EmitDefaultValue = false)]
        public List<FiatMapFiatObject> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FiatMapResponseModel {\n");
        ...
        {
            return this.Equals(input as FiatMapResponseModel);
        }

        /// <summary>
        /// Returns true if FiatMapResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of FiatMapResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FiatMapResponseModel input)
        {
            if (input == null)
                return false;
