...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// Too Many Requests
    /// </summary>
    [DataContract(Name = "HTTP Status 429 Error Object")]
    public partial class HTTPStatus429ErrorObject : IEquatable<HTTPStatus429ErrorObject>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HTTPStatus429ErrorObject" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public HTTPStatus429ErrorObject(Status3 status = default(Status3))
        {
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HTTPStatus429ErrorObject {\n");
        ...
        {
            return this.Equals(input as HTTPStatus429ErrorObject);
        }

        /// <summary>
        /// Returns true if HTTPStatus429ErrorObject instances are equal
        /// </summary>
        /// <param name="input">Instance of HTTPStatus429ErrorObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HTTPStatus429ErrorObject input)
        {
            if (input == null)
                return false;
