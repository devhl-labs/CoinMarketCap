...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// Unauthorized
    /// </summary>
    [DataContract(Name = "HTTP Status 401 Error Object")]
    public partial class HTTPStatus401ErrorObject : IEquatable<HTTPStatus401ErrorObject>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HTTPStatus401ErrorObject" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public HTTPStatus401ErrorObject(Status1 status = default(Status1))
        {
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HTTPStatus401ErrorObject {\n");
        ...
        {
            return this.Equals(input as HTTPStatus401ErrorObject);
        }

        /// <summary>
        /// Returns true if HTTPStatus401ErrorObject instances are equal
        /// </summary>
        /// <param name="input">Instance of HTTPStatus401ErrorObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HTTPStatus401ErrorObject input)
        {
            if (input == null)
                return false;
