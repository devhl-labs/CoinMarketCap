...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "current_day")]
    public partial class CurrentDay : IEquatable<CurrentDay>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrentDay" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="CurrentDay" /> class.
        /// </summary>
        /// <param name="creditsUsed">The number of API credits used during the current daily period. (required).</param>
        /// <param name="creditsLeft">The number of remaining API credits that can be used during the current daily period before receiving a HTTP 429 rate limit error. This limit resets at the end of each daily period. (required).</param>
        public CurrentDay(decimal creditsUsed = default(decimal), decimal creditsLeft = default(decimal))
        {
        ...
        /// </summary>
        /// <value>The number of API credits used during the current daily period.</value>
        ...
        /// </summary>
        /// <value>The number of remaining API credits that can be used during the current daily period before receiving a HTTP 429 rate limit error. This limit resets at the end of each daily period.</value>
        ...
        {
            return this.Equals(input as CurrentDay);
        }

        /// <summary>
        /// Returns true if CurrentDay instances are equal
        /// </summary>
        /// <param name="input">Instance of CurrentDay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CurrentDay input)
        {
            if (input == null)
            {
                return false;
