...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HTTP Status 500 Error Object")]
    public partial class HTTPStatus500ErrorObject : IEquatable<HTTPStatus500ErrorObject>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HTTPStatus500ErrorObject" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public HTTPStatus500ErrorObject(Status4 status = default(Status4))
        {
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HTTPStatus500ErrorObject {\n");
        ...
        {
            return this.Equals(input as HTTPStatus500ErrorObject);
        }

        /// <summary>
        /// Returns true if HTTPStatus500ErrorObject instances are equal
        /// </summary>
        /// <param name="input">Instance of HTTPStatus500ErrorObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HTTPStatus500ErrorObject input)
        {
            if (input == null)
            {
                return false;
