...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Tools Price Conversion - Quote object")]
    public partial class ToolsPriceConversionQuoteObject : IEquatable<ToolsPriceConversionQuoteObject>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolsPriceConversionQuoteObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ToolsPriceConversionQuoteObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolsPriceConversionQuoteObject" /> class.
        /// </summary>
        /// <param name="price">Converted price in terms of the quoted currency and historic time (if supplied). (required).</param>
        /// <param name="lastUpdated">Timestamp (ISO 8601) of when the destination currency&#39;s market value was recorded. (required).</param>
        public ToolsPriceConversionQuoteObject(decimal price = default(decimal), DateTime lastUpdated = default(DateTime))
        {
            this.Price = price;
        ...
        /// </summary>
        /// <value>Converted price in terms of the quoted currency and historic time (if supplied).</value>
        ...
        /// </summary>
        /// <value>Timestamp (ISO 8601) of when the destination currency&#39;s market value was recorded.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ToolsPriceConversionQuoteObject {\n");
        ...
        {
            return this.Equals(input as ToolsPriceConversionQuoteObject);
        }

        /// <summary>
        /// Returns true if ToolsPriceConversionQuoteObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ToolsPriceConversionQuoteObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ToolsPriceConversionQuoteObject input)
        {
            if (input == null)
            {
                return false;
