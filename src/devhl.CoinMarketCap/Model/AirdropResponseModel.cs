...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Airdrop - Response Model")]
    public partial class AirdropResponseModel : IEquatable<AirdropResponseModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AirdropResponseModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AirdropResponseModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AirdropResponseModel" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="status">status (required).</param>
        public AirdropResponseModel(AirdropResultsMap data = default(AirdropResultsMap), APIStatusObject status = default(APIStatusObject))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for AirdropResponseModel and cannot be null");
            }
            this.Data = data;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for AirdropResponseModel and cannot be null");
            }
            this.Status = status;
        }
        ...
        public AirdropResultsMap Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AirdropResponseModel {\n");
        ...
        {
            return this.Equals(input as AirdropResponseModel);
        }

        /// <summary>
        /// Returns true if AirdropResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AirdropResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AirdropResponseModel input)
        {
            if (input == null)
            {
                return false;
