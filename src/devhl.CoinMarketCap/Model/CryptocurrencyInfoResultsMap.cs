...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Cryptocurrency Info - Results map")]
    public partial class CryptocurrencyInfoResultsMap : IEquatable<CryptocurrencyInfoResultsMap>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyInfoResultsMap" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CryptocurrencyInfoResultsMap() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyInfoResultsMap" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        public CryptocurrencyInfoResultsMap(CryptocurrenciesInfoCryptocurrencyObject key = default(CryptocurrenciesInfoCryptocurrencyObject))
        {
            // to ensure "key" is required (not null)
            if (key == null) {
                throw new ArgumentNullException("key is a required property for CryptocurrencyInfoResultsMap and cannot be null");
            }
            this.Key = key;
        }
        ...
        public CryptocurrenciesInfoCryptocurrencyObject Key { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CryptocurrencyInfoResultsMap {\n");
        ...
        {
            return this.Equals(input as CryptocurrencyInfoResultsMap);
        }

        /// <summary>
        /// Returns true if CryptocurrencyInfoResultsMap instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptocurrencyInfoResultsMap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptocurrencyInfoResultsMap input)
        {
            if (input == null)
                return false;
