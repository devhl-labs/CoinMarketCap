...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// Status4
    /// </summary>
    [DataContract(Name = "status 4")]
    public partial class Status4 : IEquatable<Status4>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Status4" /> class.
        /// </summary>
        ...
        public Status4(DateTime timestamp = default(DateTime), int errorCode = default(int), string errorMessage = default(string), int elapsed = default(int), int creditCount = default(int))
        {
        ...
        {
            return this.Equals(input as Status4);
        }

        /// <summary>
        /// Returns true if Status4 instances are equal
        /// </summary>
        /// <param name="input">Instance of Status4 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Status4 input)
        {
            if (input == null)
                return false;
