...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// Bad Request
    /// </summary>
    [DataContract(Name = "HTTP Status 400 Error Object")]
    public partial class HTTPStatus400ErrorObject : IEquatable<HTTPStatus400ErrorObject>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HTTPStatus400ErrorObject" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public HTTPStatus400ErrorObject(Status status = default(Status))
        {
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HTTPStatus400ErrorObject {\n");
        ...
        {
            return this.Equals(input as HTTPStatus400ErrorObject);
        }

        /// <summary>
        /// Returns true if HTTPStatus400ErrorObject instances are equal
        /// </summary>
        /// <param name="input">Instance of HTTPStatus400ErrorObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HTTPStatus400ErrorObject input)
        {
            if (input == null)
            {
                return false;
