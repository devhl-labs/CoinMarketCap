...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Category - Results map")]
    public partial class CategoryResultsMap : IEquatable<CategoryResultsMap>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CategoryResultsMap" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CategoryResultsMap() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CategoryResultsMap" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        public CategoryResultsMap(CategoryCryptocurrencyObject key = default(CategoryCryptocurrencyObject))
        {
            // to ensure "key" is required (not null)
            if (key == null) {
                throw new ArgumentNullException("key is a required property for CategoryResultsMap and cannot be null");
            }
            this.Key = key;
        }
        ...
        public CategoryCryptocurrencyObject Key { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CategoryResultsMap {\n");
        ...
        {
            return this.Equals(input as CategoryResultsMap);
        }

        /// <summary>
        /// Returns true if CategoryResultsMap instances are equal
        /// </summary>
        /// <param name="input">Instance of CategoryResultsMap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CategoryResultsMap input)
        {
            if (input == null)
                return false;
