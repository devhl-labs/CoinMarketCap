...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Airdrops - Response Model")]
    public partial class AirdropsResponseModel : IEquatable<AirdropsResponseModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AirdropsResponseModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AirdropsResponseModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AirdropsResponseModel" /> class.
        /// </summary>
        /// <param name="data">Array of airdrop object results. (required).</param>
        /// <param name="status">status.</param>
        public AirdropsResponseModel(List<AirdropsAirdropObject> data = default(List<AirdropsAirdropObject>), APIStatusObject status = default(APIStatusObject))
        {
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for AirdropsResponseModel and cannot be null");
            }
            this.Data = data;
            this.Status = status;
        }
        ...
        /// </summary>
        /// <value>Array of airdrop object results.</value>
        [DataMember(Name = "data", IsRequired = true, EmitDefaultValue = false)]
        public List<AirdropsAirdropObject> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AirdropsResponseModel {\n");
        ...
        {
            return this.Equals(input as AirdropsResponseModel);
        }

        /// <summary>
        /// Returns true if AirdropsResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AirdropsResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AirdropsResponseModel input)
        {
            if (input == null)
            {
                return false;
