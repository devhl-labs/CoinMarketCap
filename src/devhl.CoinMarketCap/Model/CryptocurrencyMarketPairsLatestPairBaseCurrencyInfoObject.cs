...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Cryptocurrency Market Pairs Latest - Pair Base Currency Info object")]
    public partial class CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject : IEquatable<CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject" /> class.
        /// </summary>
        ...
        /// <param name="currencySymbol">The CoinMarketCap identified symbol for the base currency in this market pair. (required).</param>
        ...
        public CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject(int currencyId = default(int), string currencyName = default(string), string currencySymbol = default(string), string currencySlug = default(string), string exchangeSymbol = default(string), CurrencyTypeEnum currencyType = default(CurrencyTypeEnum))
        {
        ...
        /// </summary>
        /// <value>The CoinMarketCap identified symbol for the base currency in this market pair.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject {\n");
        ...
        {
            return this.Equals(input as CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject);
        }

        /// <summary>
        /// Returns true if CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptocurrencyMarketPairsLatestPairBaseCurrencyInfoObject input)
        {
            if (input == null)
                return false;
