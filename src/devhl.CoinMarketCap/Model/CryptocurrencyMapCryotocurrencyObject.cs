...
namespace devhl.CoinMarketCap.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Cryptocurrency Map - Cryotocurrency Object")]
    public partial class CryptocurrencyMapCryotocurrencyObject : IEquatable<CryptocurrencyMapCryotocurrencyObject>
    {
        /// <summary>
        /// The listing status of the cryptocurrency. *This field is only returned if requested through the &#x60;aux&#x60; request parameter.*
        /// </summary>
        /// <value>The listing status of the cryptocurrency. *This field is only returned if requested through the &#x60;aux&#x60; request parameter.*</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyMapCryotocurrencyObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CryptocurrencyMapCryotocurrencyObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptocurrencyMapCryotocurrencyObject" /> class.
        /// </summary>
        /// <param name="id">The unique cryptocurrency ID for this cryptocurrency. (required).</param>
        /// <param name="name">The name of this cryptocurrency. (required).</param>
        /// <param name="symbol">The ticker symbol for this cryptocurrency, always in all caps. (required).</param>
        ...
        /// <param name="status">The listing status of the cryptocurrency. *This field is only returned if requested through the &#x60;aux&#x60; request parameter.*.</param>
        /// <param name="firstHistoricalData">Timestamp (ISO 8601) of the date this cryptocurrency was first available on the platform..</param>
        /// <param name="lastHistoricalData">Timestamp (ISO 8601) of the last time this cryptocurrency&#39;s market data was updated..</param>
        /// <param name="platform">platform.</param>
        public CryptocurrencyMapCryotocurrencyObject(int id = default(int), string name = default(string), string symbol = default(string), string slug = default(string), int isActive = default(int), StatusEnum? status = default(StatusEnum?), DateTime firstHistoricalData = default(DateTime), DateTime lastHistoricalData = default(DateTime), Platform platform = default(Platform))
        {
            this.Id = id;
            this.Name = name;
            this.Symbol = symbol;
        ...
        /// </summary>
        /// <value>The unique cryptocurrency ID for this cryptocurrency.</value>
        ...
        /// </summary>
        /// <value>The ticker symbol for this cryptocurrency, always in all caps.</value>
        ...
        /// </summary>
        /// <value>Timestamp (ISO 8601) of the date this cryptocurrency was first available on the platform.</value>
        ...
        {
            return this.Equals(input as CryptocurrencyMapCryotocurrencyObject);
        }

        /// <summary>
        /// Returns true if CryptocurrencyMapCryotocurrencyObject instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptocurrencyMapCryotocurrencyObject to be compared</param>
        /// <returns>Boolean</returns>
